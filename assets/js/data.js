...
MDP.research = {
  ...
  disciplinas: [
    { id: "electronica", nombre: "Electrónica y Telecomunicaciones", w: "lorena", start: [2001, 17.27], end: [2022, 14.22],
    ...
    { id: "mecatronica", nombre: "Mecatrónica", w: "diana", start: [2016, 16.05], end: [2025, 12.75], nota: "2016 es el máximo histórico",
    ...
    { id: "comercial", nombre: "Comercial", w: "maria-cristina", sinDato: true,
    ...
    { id: "minas", nombre: "Minas", w: "andrea", start: [2001, 23.7], end: [2025, 32.6], extra: { label: "Empleo minero", v: 14.9 },
    ...
    { id: "sistemas", nombre: "Sistemas", w: "alejandra", start: [2000, 42.84], mid: [2022, 19.16], end: [2025, 17.37], nota: "El año inicial corresponde a “comienzos de siglo”",
    ...
    { id: "mecanica", nombre: "Mecánica", w: "milena", max: 12, periodo: "2001–2025",
    ...
    { id: "civil", nombre: "Civil", w: "claudia-maria", end: [2025, 31.01],
    ...
    { id: "geologia", nombre: "Geología y Geociencias", w: "jessica", range: [30, 46], periodo: "2001–2025",
